...
> **Purpose**: Intelligent file parsing for uploaded documents (Word, Excel, CSV, TXT, MD, Python, PDF, image/OCR). Extracts structured metadata for LLM context injection.
